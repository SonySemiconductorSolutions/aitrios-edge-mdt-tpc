...
class APITest(unittest.TestCase):
    def test_api_tpc_version(self):
        ...
        # TPC v6.0
        APIBaseTest(tpc_version='6.0', device_type="imx500").run_test(
            expected_tpc_path="edgemdt_tpc.data.imx500.tpc_v6_0", expected_tpc_version='6.0')
        APIBaseTest(tpc_version='6', device_type="imx500").run_test(
            expected_tpc_path="edgemdt_tpc.data.imx500.tpc_v6_0", expected_tpc_version='6.0')
    ...
    def test_api_false_tpc_version(self):
        ...
        with pytest.raises(AssertionError, match="Error: The specified TPC version '1.8' is not valid. Available "
                                                 "versions are: 1.0, 1.0_lut, 4.0, 4.1, 5.0, 6.0. Please ensure you are "
